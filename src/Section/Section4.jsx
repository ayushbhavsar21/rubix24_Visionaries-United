...
function Section4() {
  return (
    <div className='h-[130vh] overflow-hidden dark:bg-primary bg-white bg-cover bg-center flex flex-col  items-center gap-28' style={{ backgroundImage: `url(${section41})` }}>
      ...
      </div><div className='flex pl-[10vw] pr-[10vw] md:pr-0 md:justify-center md:pl-0 overflow-x-scroll  gap-8  w-full items-center' style={{
    scrollbarWidth: 'thin',
    scrollbarColor: 'grey ',
    overflowX: 'auto',
