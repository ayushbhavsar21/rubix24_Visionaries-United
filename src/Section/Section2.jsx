...
function Section2() {
  return (
    <div className='flex justify-around items-center w-full bg-primary h-[100vh]'>
      ...
      <div className='flex flex-col w-[35%] text-white font-playfair relative right-28 bottom-20 gap-4'>
       ...
       <button className='text-xs py-2 rounded-3xl bg-secondary w-[180px]'>EXPLORE MENTORS</button>
      </div>
    </div>
  )
}
